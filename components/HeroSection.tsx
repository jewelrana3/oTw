    ...
    <>
      ...
      <section className="relative min-h-screen w-full flex flex-col items-center justify-center bg-white overflow-hidden py-20 px-4">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute bottom-[5%]  sm:bottom-[20%] left-[10%]  sm:left-[20%] rotate-[-10deg] ">
            <Image src={two} alt="Two" />
          </div>

          <div className="absolute bottom-[5%]  sm:bottom-[20%] right-[10%] sm:right-[20%] rotate-25 bg-[#34e0a1] p-4 rounded-3xl shadow-lg">
        ...
        {/* 3. Main Content */}
        <div className=" z-10 text-center max-w-4xl mx-auto mt-36 lg:mt-0">
          <h1 className="text-gray-900 mb-8 tracking-tight">
            ...
            <br />
            <span className="text-gray-900 md:text-4xl">
              Property Management
            </span>
          </h1>
